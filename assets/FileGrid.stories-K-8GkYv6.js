import{j as r,a as e}from"./emotion-react-jsx-runtime.browser.esm-D7l8D3v7.js";import{k as N}from"./index-DACGP-7d.js";import{l as B,V as m,n as A,a as z,W as J,I as u,H as g}from"./index-Bt3YSxOM.js";import{r as K}from"./index-WrzbD7O6.js";import"./index-CMu-bRpU.js";import{u as M}from"./useOverlay-CXAnpLrg.js";import{c as Q,i as U,g as X,n as Y,o as Z,a as f,O as y,t as v}from"./index.style-BcqN2-Un.js";import{d as $}from"./document-D0W7_mR3.js";import{g as ee}from"./file-BOKWjNGN.js";import"./iframe-BDSbo69l.js";import"./jsx-runtime-3CO4_yYD.js";import"./_commonjsHelpers-BCr5jcs0.js";import"./emotion-react.browser.esm-BWTRK3db.js";import"./ellipsis-C1UI7iJ_.js";import"../sb-preview/runtime.js";(function(){try{var a=typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},t=new a.Error().stack;t&&(a._sentryDebugIds=a._sentryDebugIds||{},a._sentryDebugIds[t]="2867a947-542b-453c-a3ed-04ae6352311d",a._sentryDebugIdIdentifier="sentry-dbid-2867a947-542b-453c-a3ed-04ae6352311d")}catch{}})();const O=({name:a,capacity:t,type:d,url:V,variant:n="primary",isSelectable:C=!1,onSelect:c,isSelected:P=!1,isDeleted:k=!1,onDelete:W=()=>{}})=>{const{isOpen:E,close:L,toggle:R}=M(),p=K.useRef(null),G=()=>{if(!p.current)return!1;const{y:H}=p.current.getBoundingClientRect();return H+118+20<document.documentElement.clientHeight-48};return r("article",{css:Q(n!=="primary"),children:[C&&e(B,{css:{position:"absolute",right:20},isChecked:P,onChange:()=>c==null?void 0:c()}),e("div",{css:U(n!=="primary"),children:X(d)}),r(m,{styles:{direction:"column",gap:n==="primary"?"1.2rem":"0.8rem"},children:[r(m,{styles:{width:"100%",justify:"space-between",align:"center"},children:[e(A,{css:Y,tag:"H3",children:a}),n==="primary"&&r(z,{onClose:L,children:[e("div",{ref:p,children:!k&&e(N,{onClick:R,css:{cursor:"pointer"},width:16,height:16})}),r(J,{css:Z(G()),isOpen:E,children:[e(u,{css:f,LeftIcon:y.download,onSelect:()=>{$(V,a)},children:"파일 다운로드"}),e(u,{css:f,LeftIcon:y.deleted,onSelect:W,children:"휴지통으로 이동"}),e(u,{css:f,LeftIcon:y.handover,onSelect:()=>{alert("준비 중인 기능입니다.")},children:"인수인계 노트 보기"})]})]})]}),r(m,{styles:{width:"100%",justify:"space-between",align:"center"},children:[r(g,{tag:"body8",css:v,children:[d," 문서"]}),e(g,{tag:"body8",css:v,children:ee(t??0)})]})]})]})};O.__docgenInfo={description:"",methods:[],displayName:"FileGrid",props:{variant:{required:!1,tsType:{name:"union",raw:"'primary' | 'secondary'",elements:[{name:"literal",value:"'primary'"},{name:"literal",value:"'secondary'"}]},description:"",defaultValue:{value:"'primary'",computed:!1}},type:{required:!0,tsType:{name:"union",raw:`| 'jpg'
| 'jpeg'
| 'png'
| 'webp'
| 'avif'
