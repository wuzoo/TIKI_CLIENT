import{j as b,a as t}from"./emotion-react-jsx-runtime.browser.esm-zkvds-JB.js";import{s as v,t as I}from"./index-BfBeqfpZ.js";import{h as s,l as w,K as k}from"./index-8aeUlQ8v.js";import{r as M}from"./index-C9zVwuqM.js";import{c as n}from"./emotion-react.browser.esm-BQhGCPDg.js";import"./iframe-C9tcbjn1.js";import{m as _}from"./proxy-OBO9AQ8F.js";import"./jsx-runtime-BtWJh0sj.js";import"./index-BzqRhAmC.js";import"./_commonjsHelpers-BD_-Q7dq.js";import"../sb-preview/runtime.js";(function(){try{var e=typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},r=new e.Error().stack;r&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[r]="b7ef4112-cfc1-42a0-9805-78403db7ef72",e._sentryDebugIdIdentifier="sentry-dbid-b7ef4112-cfc1-42a0-9805-78403db7ef72")}catch{}})();const x=e=>n({display:"flex",alignItems:"center",justifyContent:"center",width:"3.6rem",height:"3.6rem",padding:"0.1rem",backgroundColor:s.colors.gray_100,borderRadius:"10px",border:e?`1px solid ${s.colors.key_500}`:"transparent","&:hover":{border:`1px solid ${s.colors.key_500}`},"& > img":{width:"3.3rem",height:"3.3rem",borderRadius:"9px",objectFit:"cover"},cursor:"pointer"}),q=n({position:"absolute",left:0}),j=n({font:`${s.text.body06}`,color:s.colors.gray_500}),S=(e,r)=>n({width:"0.4rem",height:e?"2.4rem":r?"1.6rem":0,borderRadius:"0 100px 100px 0",backgroundColor:e?s.colors.key_500:r?s.colors.key_300:s.colors.white}),D=e=>{switch(e==null?void 0:e.type){case"add":return t(I,{width:16,height:16});case"dashboard":return t(v,{width:20,height:20});case"team":return e.logoUrl?t("img",{src:e.logoUrl,alt:"팀 프로필 이미지"}):t("span",{css:j,children:e.hoverMessage[0]})}},i=({variant:e,isClicked:r,onLogoClick:a,...p})=>{const[g,d]=M.useState(!1),m=()=>{d(!0)},y=()=>{d(!1)},h=f=>{f.key==="Enter"&&a()};return b(k,{tag:"li",styles:{align:"center",justify:"center",padding:"2rem"},...p,children:[r&&t(_.div,{layoutId:"snb_indicator",css:[S(r,g),q]}),t(w,{message:e.hoverMessage,position:"right",gap:.8,children:t("div",{role:"button",tabIndex:0,css:x(r),onClick:a,onKeyDown:h,onMouseEnter:m,onMouseLeave:y,children:D(e)})})]})};i.__docgenInfo={description:"",methods:[],displayName:"Item",props:{variant:{required:!0,tsType:{name:"union",raw:`| {
    type: 'add';
    hoverMessage: string;
  }
| {
